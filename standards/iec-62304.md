...
* SHALL demonstrate the software meets its requirements via use of a quality management system (4.1)
* SHALL apply a risk management process compliant with ISO 14971 (4.2)
...
* Software development plan SHALL be established (5.1.1), and address:
  * SHALL address processes, deliverables, trace between user requirements, software requirements, testing, risk control measures; software configuration, tooling to support development, change control, problem resolution
  * SHALL reference the system design (5.1.3)
  ...
  * SHALL describe what will be under change control, when and how changes will be made (5.1.9, 5.1.10)
* SHALL document software system requirements from system requirements (5.2.1)
  * SHALL include functional and capable requirements, software inputs and outputs, interfaces between software systems, software-driven warnings/alarms, security capabilities, user interface requirements, data and database definitions, installation and acceptance criteria, operational and maintenance requirements, network requirements, user maintenance, regulatory requirements impacting the design, risk control measures (5.2.3)
* SHALL document the requirements implement system requirements including those relating to risk control, are not contradictory, are unambiguous and can be used to define tests, are identifiable and traceable (5.2.6)
...
* SHALL retest after modificaitons (5.7.3)
...
* SHALL communicate changes to users and regulators (6.2.5)
  * especially for problems in released software and consequences of not updating
